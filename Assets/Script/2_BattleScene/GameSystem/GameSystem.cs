...
namespace TouhouMachineLearningSummary.GameSystem
{
    ...
    {
        //设置
        public static async Task Set(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Set]);
        //增益
        public static async Task Gain(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Gain]);
        //伤害
        public static async Task Hurt(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Hurt]);
        //治愈
        public static async Task Cure(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Cure]);
        //重置
        public static async Task Reset(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Reset]);
        //强化
        public static async Task Strengthen(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Strengthen]);
        //削弱
        public static async Task Weak(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Weak]);
        //摧毁
        public static async Task Destory(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Destory]);
        //逆转
        public static async Task Reversal(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Reverse]);
        //增加
        public static async Task Increase(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Increase]);
        //减少
        public static async Task Decrease(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Decrease]);
    }
    /// <summary>
    ...
    public class TransferSystem
    {
        ...
        /// <param name="e"></param>
        /// <returns></returns>
        public static async Task GenerateCard(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[CardCommand.GenerateCard(e.targetCardId)][TriggerType.Generate]);
        /// <summary>
        /// 在战场区各个区域间移动卡牌(触发移动连锁效果)
        /// </summary>
        public static async Task MoveCard(Model.Event e)
        {
        ...
        /// </summary>
        public static async Task DrawCard(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Draw]);
        /// <summary>
        /// 回手，从战场区移动至手牌区（不触发移动连锁效果)
        /// </summary>
        public static async Task RecycleCard(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Reverse]);

        /// <summary>
        /// 只支持单个牌被打出
        /// 打出，从手牌区\战场区打出至使用区(不触发移动连锁效果)
        /// </summary>
        public static async Task PlayCard(Model.Event e, bool isAnsy = true)
        {
        ...
        /// </summary>
        public static async Task ReviveCard(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Revive]);
        /// <summary>
        /// 部署，从使用区移动至战场区(不触发移动连锁效果)
        /// 若为重新触发则不改变位置直接触发部署效果
        /// </summary>
        public static async Task DeployCard(Model.Event e, bool ReTrigger = false)
        {
        ...
        /// </summary>
        public static async Task SummonCard(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Summon]);

        /// <summary>
        /// 弃牌，从手牌区移动至墓地(不触发移动连锁效果)
        /// </summary>
        public static async Task DisCard(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Discard]);
        /// <summary>
        /// 死亡，从战场区移动至墓地(不触发移动连锁效果)
        /// </summary>
        public static async Task DeadCard(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Dead]);

        /// <summary>
        /// 间隙，从对局区移除至场外(不触发移动连锁效果)
        /// </summary>
        public static async Task BanishCard(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.Banish]);
    ...
    {
        public static async Task SetState(Model.Event e)
        {
        ...
        public static async Task ClearState(Model.Event e)
        {
            //筛选触发目标，对包含该状态的卡牌才会清空状态
            e.targetCards = e.targetCards.Where(card => card[e.targetState]).ToList();
            await GameSystemCommand.TriggerBroadcast(e[TriggerType.StateClear]);
        }
        public static async Task ChangeState(Model.Event e)
        {
    ...
    public class FieldSystem
    {
        ...
        /// </summary>
        public static async Task SetField(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.FieldSet]);
        /// <summary>
        /// 设置字段值改变量，若为正数则触发"字段增加"衍生效果，若为负数则触发"字段减少"衍生效果
        /// </summary>
        public static async Task ChangeField(Model.Event e) => await GameSystemCommand.TriggerBroadcast(e[TriggerType.FieldChange]);
    }
    /// <summary>
    /// 异变系统
    /// </summary>
    ...
    {
        public static async Task WhenTurnStart() => await GameSystemCommand.TriggerNotice(new Model.Event(null, AgainstInfo.cardSet.CardList)[TriggerType.TurnStart]);
        public static async Task WhenTurnEnd() => await GameSystemCommand.TriggerNotice(new Model.Event(null, AgainstInfo.cardSet.CardList)[TriggerType.TurnEnd]);
        public static async Task WhenRoundStart() => await GameSystemCommand.TriggerNotice(new Model.Event(null, AgainstInfo.cardSet.CardList)[TriggerType.RoundStart]);
        public static async Task WhenRoundEnd() => await GameSystemCommand.TriggerNotice(new Model.Event(null, AgainstInfo.cardSet.CardList)[TriggerType.RoundEnd]);
    }
    /// <summary>
    /// 获取游戏内对战信息的高层api接口
    /// </summary>
