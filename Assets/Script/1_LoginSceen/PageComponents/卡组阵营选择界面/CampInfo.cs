...
namespace TouhouMachineLearningSummary.Info
{
    public class CampInfo
    {
        ...
        public static void Init()
        {
            //从配置文件载入相应阵营信息，先搞个假的
            campInfos.Clear();
            campInfos.Add(new SingleCampInfo(Camp.Taoism, "道教", "没有东西的空架子哦",Info.CardCompnentInfo.instance.TaoismTex));
            campInfos.Add(new SingleCampInfo(Camp.science, "科学", "没有东西的空架子哦", Info.CardCompnentInfo.instance.scienceTex));
            campInfos.Add(new SingleCampInfo(Camp.Buddhism, "佛教", "没有东西的空架子哦", Info.CardCompnentInfo.instance.BuddhismTex));
            campInfos.Add(new SingleCampInfo(Camp.Shintoism, "神道教", "没有东西的空架子哦", Info.CardCompnentInfo.instance.ShintoismTex));
        }
